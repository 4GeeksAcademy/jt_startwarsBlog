					...
					<div className="card m-2 col-12 col-md-4 col-lg-3 col-xl-2" key= {index}>
						<img src={`https://starwars-visualguide.com/assets/img/characters/${index+1}.jpg`} className="card-img-top" alt="..."/>
							<div className="card-body">
						  		...
						  		<button className="btn btn-danger mx-2" onClick={() => actions.setFavorite(characters.name)} disabled={store.favorites.includes(characters.name)}><i className="fas fa-heart"></i></button>
					  		</div>
			 		</div>
					)}
		)
